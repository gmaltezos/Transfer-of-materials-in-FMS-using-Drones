...
evalin('base','Vehicle.Airframe.mass = 5.893;');
evalin('base','Vehicle.Airframe.inertia = diag([0.17265001194 0.197880936 0.368868474]);');
evalin('base','Estimator.pos.opticalFlowToVelocityGain = 1;');
evalin('base','Sensors.velocityToOpticalFlowGain = 1;');
evalin('base','Controller.takeoffGain = 0.;');

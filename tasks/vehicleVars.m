...
Vehicle.Motor.minLimit = 0;
%Vehicle.Motor.commandToW2Gain = 13840.8; %motor command for Rolling Spider (0-500) to motorspeed^2
Vehicle.Motor.commandToW2Gain = 1438000.8; %motor command for Rolling Spider (0-500) to motorspeed^2
